...
<template>
    <div class="tw-py-10">
        <el-card class="tw-w-1/2 md:tw-w-1/3">
            <router-link
                :to="{ name: 'calculator' }"
                class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-font-bold tw-text-[#333]">
                <svg
                    class="tw-mb-1 tw-h-8 tw-w-8 tw-fill-[#333]"
